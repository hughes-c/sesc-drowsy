...
#if (defined TM)
enum transInstType {
  transLoad = 0,    // Transactional Load Instruction
  transStore,   // Transactional Store Instruction
  transInt,     // Transactional Integer Instruction
  transFp,      // Transactional Floating Point
  transBJ,      // Transactional Branches/Jumps
  transFence,   // Transactional Fetch&Op, iMemFence, iAcquire, iRelease (Not iLoad or iStore)
  transNT,      // All Non transactional instructions (6)
  transBegin,   // Transactional Begin Instruction
  transCommit,  // Transactional Commit Instruction
  transAbort,   // Transactional Abort Instruction
  transOther    // All Other Transactional Instructions
};
