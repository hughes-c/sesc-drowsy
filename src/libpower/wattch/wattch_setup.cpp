...
void wattch_setup()
{
  ...
  // Overhead for Bloom Filter
  // Includes 2x512B SRAM and 2x 64 XOR Trees at 65nm
  double numHashes = 2;
  double SRAM_64B  = 3.65672e-01;
  double totalSRAM = numHashes * SRAM_64B;
  double XOR       = 1.07392945e-15;
  double HASHFUNC  = 160 * XOR;
  double totalHash = numHashes * HASHFUNC;
  double sigFactor = totalHash + totalSRAM;
  SescConf->updateRecord(proc,"signatureEnergy", sigFactor);
