...
#if (defined TM)
/* Only space for four operans, immediate used
 * to indicate unique transactions.
 */
opnum_t tm_opnums[] = {
  tmBegin_opn,      // Operand: 011100b
  tmAbort_opn,      // Operand: 011101b
  reserved_opn,     // Operand: 011110b
  tmCommit_opn,     // Operand: 011111b
};
#endif
...
#if (defined TM)
    ,
    { "tmBegin",    tmBegin_op,  { 0, 0, 0, 0}, 0, 0, 1},
    { "tmAbort",    tmAbort_op,  { 0, 0, 0, 0}, 0, 0, 1},
    { "tmCommit",   tmCommit_op,    { 0, 0, 0, 0}, 0, 0, 1}
#endif
};
