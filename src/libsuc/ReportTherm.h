...
private:
  ...
  //Trans Power
  static std::string fileName_powerTrace;
...
public:
  ...
  //Trans Power
  static std::ofstream powerTraceFile;

  static void openPowerTraceFile(std::string fileName);
  static void closePowerTraceFile();

  static std::string IntToString(int64_t input);
  static void flush_file(std::ostream &outputStream);
  static void field_to_file(std::string fieldIn, std::ostream &outputStream);
  static void fieldRaw_to_file(double val, std::ostream &outputStream);
};
