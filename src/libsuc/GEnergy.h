...
class EnergyStore {
private:
   std::vector< const char * > proc;
//    const char *proc;    --revert and change constructor and get fucntions in GEnergy.cpp
...
public:
  ...
  #if defined(SEP_DVFS)
  static double getTotalGroupPower(PowerGroup grp);
  static double getTotalGroupEnergy(PowerGroup grp);

  static double getTotalProcPower(int procId);
  static double getTotalProcEnergy(int procId);

  static double getProcClockPower(int procId);
  #endif

  static void dump(int procId);
  static void dump();
//
  static inline Time_t get_sampleTime(void) { return SAMPLE_TIME; };

  static void dumpPowerTrace(int procId, Time_t interval, std::ostream &outStream);
  static void dumpEnergyTrace(int procId, Time_t interval, std::ostream &outStream);
//
  static double getTotalEnergy(void);
  static double getTotalPower(void);
