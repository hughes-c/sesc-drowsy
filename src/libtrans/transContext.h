...
class transactionContext
{
  public:
    ...
    std::map<RAddr, IntRegValue>::iterator cacheGetEndIterator();
    std::map<RAddr, IntRegValue>::iterator cacheGetBeginIterator();
...
inline std::map<RAddr, IntRegValue>::iterator transactionContext::cacheGetBeginIterator(){
  return this->cache.getBeginIterator();
}

inline std::map<RAddr, IntRegValue>::iterator transactionContext::cacheGetEndIterator(){
